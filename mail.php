...
function sendCustomEmail($email, $name, $subject, $message) {
...
// Example usage:
$email = 'abakpadavid05@gmail.com';
$name = 'John Doe';
$subject = 'Test Email from Kasoowa';
$message = 'This is a <b>test email</b> sent from Kasoowa.';

echo sendCustomEmail($email, $name, $subject, $message);
?>
