...
<head>
   ...
   <meta name="viewport" content="width=device-width,initial-scale=1.0">
    ...
    <link rel="stylesheet" href="dispute.css?v=1.9">
...
<section class="dispute_head">
<strong>Lodge A dispute</strong>
</section>
<section class="dispute_section">
    <?php
$oid=$_GET['oid'];
...
?>
<form enctype="multipart/form-data" onsubmit="lodge_dispute()" action="dispute_process.php" method="POST">
<div style="background:rgba(0,0,0,0.03)" class="cont">
    <input name="order_id" required value="<?php echo $uniqid; ?>" readonly placeholder="" class="cont_input">
    <label class="float">Order ID</label>
</div>
<div class="cont">
    <select name="dispute_reason" required onchange="reason(this)" class="cont_input">
        <option value="">Select reason</option>
        <option>Wrong item Received</option>
        <option>Damaged product</option>
        <option>Incorrect quantity</option>
        <option>Expired or near expiry</option>
        <option>Not satisfied with the packaging</option>
        <option value="other">other</option>
    </select>
    <label class="float">Reason</label>
</div>
<section style="width:100%" class="create">

</section>
<section class="photo_section">
<label for="attach" class="attachment">
    <span class='attach_span'>Attach files(required)</span>
    +
</label>

    </section>
<input name="attach[]" required multiple onchange="preview(this)" style="display:none" type="file" accept="image/*" id="attach">
<textarea name="details" required></textarea>
<button type="submit" class='submit_dispute'>Submit Dispute <i class="material-icons">chevron_right</i></button>
    </form>
</section>
